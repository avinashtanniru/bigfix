...
foreach ($Computers in $AllcomputerList)
{
    ...
    Try{
        ...
        $regKey.SetValue("value","http://172.22.0.21:52311/bfmirror/downloads",[Microsoft.Win32.RegistryValueKind]::String)
        ...
        $regKey.SetValue("value","http://172.22.0.21:52311",[Microsoft.Win32.RegistryValueKind]::String)
