...
$AllcomputerList =  Get-Content -Path ".\servers.txt"
...
foreach ($Computers in $AllcomputerList)
{
    ...
    Try{
        ...
        $regKey.SetValue("value","http://10.162.64.17:52311/bfmirror/downloads",[Microsoft.Win32.RegistryValueKind]::String)
        ...
        $regKey.SetValue("value","http://10.162.64.17:52311",[Microsoft.Win32.RegistryValueKind]::String)
...
$StorageBOX | Sort-Object Status -Descending | Out-File -FilePath ".\Log_Status.txt"